...
>(({ className, children, prefixIcon, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-[50px] w-full items-center justify-between whitespace-nowrap rounded-lg border border-gray-200 border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-within:border-primary focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >

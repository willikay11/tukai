    ...
    return (
      <div className="flex items-center rounded-[10px] border border-gray-700 border-input px-3 focus-within:border-primary focus-within:outline-none disabled:cursor-not-allowed disabled:opacity-50">
        ...
        <input
          type={type}
          className={cn(
            'h-[50px] w-full flex-1 origin-left scale-[0.875] border-none bg-transparent py-1 text-[16px] placeholder:text-xs placeholder:text-gray-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            className,
          )}
          ref={ref}
          {...props}

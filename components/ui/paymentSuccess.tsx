...
export default function PaymentSuccess({
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={() => closeModal(false)}>
      <AlertDialogContent className="flex rounded-lg h-auto w-[calc(100%-32px)] flex-col items-center justify-center gap-4 p-6 sm:h-[21rem] sm:w-[30rem] sm:max-w-none sm:p-0">
        ...
        <div className="flex flex-col items-center gap-2 px-6">
          <p className="text-sm text-gray-700 text-center">Your payment was made successfully.</p>

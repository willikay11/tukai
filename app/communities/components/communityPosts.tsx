...
export default function CommunityPosts({}) {
  ...
  return (
    <div className="grid grid-cols-12 gap-2">
      <div className="col-span-12 md:col-span-6 md:col-start-4 lg:col-span-6 lg:col-start-4 xl:col-span-4 xl:col-start-5 3xl:col-span-4 3xl:col-start-5 4xl:col-span-4 4xl:col-start-5 md:mx-0">
        {isLoading ? (
          <>
            <PostSkeleton />
            <PostSkeleton />

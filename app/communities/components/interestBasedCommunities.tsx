...
export default function InterestBasedCommunities({ interest }: { interest: Interest }) {
    const { data: communities, isLoading, error } = useInterestBasedCommunities({ page: 1, enabled: true, category: interest.id });
    ...
    return (
        ...
        <div className="inline-flex items-center gap-2">
            <div className="inline-flex items-center gap-2">
                {interest.icon && <div className="rounded-full bg-gray-100 p-2"><IconComponent iconName={interest.icon} size={18} /></div>} 

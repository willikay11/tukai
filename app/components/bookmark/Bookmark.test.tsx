...
describe('Bookmark Component', () => {
  ...
  it('should call onBookmark when not bookmarked and clicked', () => {
    ...
    render(<Bookmark userId={"8129381931983"} bookmarked={false} onBookmark={onBookmark} onUnbookmark={jest.fn()} />);
  ...
  it('should call onUnbookmark when bookmarked and clicked', () => {
    ...
    render(<Bookmark userId={"8129381931983"} bookmarked={true} onBookmark={jest.fn()} onUnbookmark={onUnbookmark} />);
    const button = screen.getByRole('button');
    fireEvent.click(button);
  ...
  it('should toggle the icon variant on click', () => {
    render(<Bookmark userId={"8129381931983"} bookmarked={false} onBookmark={jest.fn()} onUnbookmark={jest.fn()} />);
    const button = screen.getByRole('button');

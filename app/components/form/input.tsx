  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <I
          className="w-full text-base scale-[0.875] origin-left transform font-medium text-gray-500 outline-0 focus:outline-none focus:ring-0 placeholder:text-base"
          name={name}

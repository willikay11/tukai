                    ...
                    <SelectedCategoryProvider>
                      <div className="relative flex min-h-screen flex-col">
                        <div className="z-50 grid grid-cols-12 bg-gray-50 md:sticky md:top-0 md:gap-x-4">
                          ...
                          {/* Browser */}
                          <div className="col-span-12 mx-4 md:col-span-6 md:col-start-4 lg:col-span-10 lg:col-start-2 xl:col-span-10 xl:col-start-2 3xl:col-span-8 3xl:col-start-3 md:mx-0">

...
export const EditExcludedField = ({
  experienceId,
  currentExcluded = '',
  onSave,
  onCancel,
}: EditExcludedFieldProps) => {
  ...
  }, [excluded, experienceId, updateExperienceAsync, onSave, toast]);
    ...
    <div className="space-y-4">
      <div>
        ...
        <Editor
          ...
          editorSerializedState={toSerializedEditorState(excluded)}

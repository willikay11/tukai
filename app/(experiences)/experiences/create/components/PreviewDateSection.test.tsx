...
describe('PreviewDateSection', () => {
  it('renders section title', () => {
    render(<PreviewDateSection date={null} startTime={null} endTime={null} />);
  ...
  it('displays formatted date and time when provided', () => {
    render(<PreviewDateSection date="2026-05-15" startTime="09:00" endTime="17:00" />);
  ...
  it('renders edit button when onEdit is provided', () => {
    ...
    render(<PreviewDateSection date={null} startTime={null} endTime={null} onEdit={onEdit} />);

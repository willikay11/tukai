...
describe('PreviewDescriptionSection', () => {
  describe('Rendering', () => {
    ...
    it('displays the description text', () => {
      render(
        <PreviewDescriptionSection description="<p>A wonderful experience awaits</p>" />
      );
    ...
    it('does not display edit icon when onEdit not provided', () => {
      render(
        <PreviewDescriptionSection description="<p>Test</p>" />
      );
  ...
  describe('HTML Description Display', () => {
    ...
    it('renders empty description', () => {
      const { container } = render(
        <PreviewDescriptionSection description="" />
      );
      expect(container).toBeInTheDocument();
    });
  });
